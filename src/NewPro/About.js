...
{/* <div id="loading-area"></div> */}
    ...
    <div class="page-content bg-white">
		...
		<div class="content-block">
			...
			{/* <!-- Why Chose Us --> */}
			{/* <!-- Call To Action --> */}
			<div class="section-full content-inner-2 call-to-action overlay-black-dark text-white text-center bg-img-fix" style={{backgroundImage:'url(images/background/bg4.jpg)'}}>
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
