...
<div class="page-wraper">
                ...
                <div class="container clearfix">
                    ...
                    <div class="header-nav navbar-collapse justify-content-start" id="navbarNavDropdown">
                        <ul class="nav navbar-nav">
							...
							<li>
								<a href="/home">For Candidates <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
							...
							<li>
								<a href="/home">For Employers <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
    ...
    <div class="page-content bg-white">
        {/* <!-- inner page banner --> */}
        <div class="dez-bnr-inr overlay-black-middle bg-pt" style={{backgroundImage:'url(images/banner/bnr2.jpg)'}}>
            <div class="container">
